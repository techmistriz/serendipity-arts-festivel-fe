// "What stayed with them" — testimonials used on the homepage.
// Rendered with schema.org Review JSON-LD for SEO.
import shaw from "@/assets/testimonials/shaw.jpg.asset.json";
import khanwalkar from "@/assets/testimonials/khanwalkar.jpg.asset.json";
import ghosh from "@/assets/testimonials/ghosh.jpg.asset.json";
import ojha from "@/assets/testimonials/ojha.jpg.asset.json";
import parrikar from "@/assets/testimonials/parrikar.jpg.asset.json";
import pradhan from "@/assets/testimonials/pradhan.jpg.asset.json";
import slagter from "@/assets/testimonials/slagter.jpg.asset.json";
