...
export const RECOMMENDER_OPTIONS: RecommenderOption[] = [
  ...
  { id: "exhibitions", label: "I like to enjoy art exhibitions", match: ["Exhibition", "Visual Arts"] },
  { id: "foodie", label: "I'm a foodie and love different cuisines", match: ["Culinary Arts"] },
  { id: "children", label: "I have children who'd enjoy stimulating programmes", match: ["Children's Programmes"] },
  { id: "crafts", label: "I'm into crafts — workshop or exhibition, either works", match: ["Crafts", "Workshop"] },
  { id: "films", label: "I'm a film enthusiast and love underrated films", match: ["Film Screening"] },
