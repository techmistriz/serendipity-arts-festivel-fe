...
export const TESTIMONIALS: Testimonial[] = [
...

  {
    ...
    initials: "WS",
    img: images.testimonials.slagter,
    quote:
...

  {
    ...
    initials: "SK",
    img: images.testimonials.khanwalkar,
    quote:
...

  {
    ...
    initials: "AP",
    img: images.testimonials.pradhan,
    quote:
...

  {
    ...
    initials: "MP",
    img: images.testimonials.parrikar,
    quote:
