// Mobile app skin — same screen structure as the finalised app,
// re-skinned in the festival's editorial / glitch design language.
import { createFileRoute } from "@tanstack/react-router";
import { useEffect, useState } from "react";
import whiteLogo from "@/assets/saf-logo-white-2026.png.asset.json";
import blackLogo from "@/assets/saf-logo-2026.png.asset.json";
import filmAsset from "@/assets/saf-aftermovie.mp4.asset.json";
import { PROGRAMMES, dateLabel, timeLabel, type Programme } from "@/lib/programmes-data";
...
export const Route = createFileRoute("/app")({
  head: () => ({
    meta: [
      { title: "Serendipity Arts Festival — App Design" },
      {
        name: "description",
        content:
          "Screen-by-screen design of the Serendipity Arts Festival mobile app: splash, login, home, programmes, booking and festival menu.",
      },
      { property: "og:title", content: "Serendipity Arts Festival — App Design" },
      {
        property: "og:description",
        content: "The festival app, skinned in the 2026 editorial and glitch identity.",
      },
  ...
  return (
    <div className="relative h-full bg-foreground overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-6">
        <img src={whiteLogo.url} alt="Serendipity Arts Festival 2026" className="w-[62%] brightness-0 invert" />
  ...
  return (
    <div className="relative h-full bg-background">
      <div className="relative h-full flex flex-col justify-between p-6">
        <img src={blackLogo.url} alt="Serendipity Arts Festival 2026" className="w-[60%]" />
...
function Welcome({ onStart }: { onStart: () => void }) {
  return (
    <div className="relative h-full">
      <img src={PROGRAMMES[1].img} alt="" className="absolute inset-0 h-full w-full object-cover" />
      ...
      <Scroll>
        <div className="px-4 pt-4">
          <div className="flex items-start justify-between gap-3">
            <img src={blackLogo.url} alt="Serendipity Arts Festival 2026" className="w-[52%]" />
        ...
        <div className="mt-5 px-4">
          <div className="relative border border-foreground overflow-hidden">
            <img src={PROGRAMMES[1].img} alt="Festival banner" className="w-full aspect-[16/10] object-cover" />
            ...
            {highlights.map((h) => {
              ...
              return (
                <button key={h} onClick={() => onOpen(p)} className="shrink-0 w-40 text-left">
                  <img src={p.img} alt={h} className="w-full aspect-square object-cover border border-foreground" />
...
function Card({ p, onOpen }: { p: Programme; onOpen: (p: Programme) => void }) {
  return (
    <button onClick={() => onOpen(p)} className="text-left">
      <img src={p.img} alt={p.title} className="w-full aspect-square object-cover border border-foreground" />
    ...
    <div className="h-full">
      <Scroll>
        ...
        <div className="px-4 pt-4">
          ...
          <img src={p.img} alt={p.title} className="mt-3 w-full aspect-[4/3] object-cover border border-foreground" />
          ...
          <div className="mt-3 space-y-3">
            {(p.includes?.length
              ...
              <div key={i.title} className="flex gap-3 items-center border border-foreground p-2">
                <img src={p.img} alt="" className="w-16 h-16 object-cover" />
                <div>
