...
import dashMotif from "@/assets/dash-motif.png.asset.json";
  ...
  head: () => ({
    meta: [
      { title: "Serendipity Arts Festival 2026" },
      {
        name: "description",
        content:
          "Eight days of exhibitions, performances, workshops and more. 13–20 December 2026, Panjim.",
      },
    ],
  }),
  component: Home,
  ...
  return (
    <div>
      ...
      <section className="container-editorial mt-20 md:mt-32">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-8 md:gap-x-6 md:gap-y-14">
          {[...PROGRAMMES].sort((a, b) => a.title.localeCompare(b.title)).map((p, i) => (
            <Link key={i} to="/programmes" className="group block">
        ...
        <div className="mt-10 flex justify-end">
          <Link to="/programmes" className="label hover:text-accent transition-colors">
            All programmes &nbsp;→
          </Link>
        </div>
      </section>
      ...
      <section className="container-editorial mt-20 md:mt-32">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-8">
          {featuredCurators.map((c, i) => (
            <Link key={c.name} to="/curators" className="group block">
        ...
        <div className="mt-10 flex justify-end">
          <Link to="/curators" className="label hover:text-accent transition-colors">
            All curators &nbsp;→
          </Link>
        </div>
      </section>
      ...
      <section className="container-editorial mt-20 md:mt-32">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-8">
          {[
            { img: gmcImg.url, name: "The Old GMC Complex" },
            { img: artParkImg.url, name: "Art Park" },
            { img: promenadeImg.url, name: "Promenade" },
            { img: sambaImg.url, name: "Samba Square" },
          ].sort((a, b) => a.name.localeCompare(b.name)).map((v) => (
            <Link key={v.name} to="/venues" className="group block">
        ...
        <div className="mt-10 flex justify-end">
          <Link to="/venues" className="label hover:text-accent transition-colors">
            All venues &nbsp;→
          </Link>
        </div>
      </section>
        ...
        <div className="border border-foreground p-5 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10">
            <div className="md:col-span-3">
              {t.img ? (
                <img src={t.img} alt={t.name} loading="lazy" className="w-32 md:w-full md:max-w-[220px] aspect-square object-cover border border-foreground" />
              ) : (
      ...
      <section className="container-editorial mt-20 md:mt-32">
        ...
        <div className="mt-8 flex justify-end">
          <Link to="/partners" className="label hover:text-accent transition-colors">All partners &nbsp;&rarr;</Link>
        </div>
      </section>
