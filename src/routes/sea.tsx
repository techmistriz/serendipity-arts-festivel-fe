...
export const Route = createFileRoute("/sea")({
  head: () => ({
    meta: [
      { title: "SEA — Serendipity Exchange for the Arts 2026" },
      {
        name: "description",
        content:
          "The Serendipity Exchange for the Arts (SEA) is a delegate programme running parallel to Serendipity Arts Festival 2026 — for artists, curators, producers and arts managers.",
      },
      { property: "og:title", content: "SEA — Serendipity Exchange for the Arts 2026" },
      {
        property: "og:description",
        content:
          "A delegate platform to present work, exchange ideas and foster collaborations at Serendipity Arts Festival 2026.",
      },
      ...
      <div className="mt-10 md:mt-16 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
        <div className="md:col-span-7">
          ...
          <p className="mt-6 headline text-base md:text-lg text-muted-foreground max-w-prose">
            Serendipity Exchange for the Arts (SEA) is a delegate program running parallel to the Serendipity Arts Festival (SAF) 2026. It is envisioned as a vital platform for artists, companies, curators, producers, and arts managers to present their work, exchange ideas, and foster future collaborations, thereby reaching newer and wider audiences.
          </p>
        </div>
        ...
        <aside className="md:col-span-5">
          <div className="border border-foreground p-6 md:p-8">
            ...
            <p className="mt-4 text-sm text-muted-foreground headline">
              Email, full name, gender, country, state, city and a verified WhatsApp number. That's it.
            </p>
            <Link
              to="/register"
              search={{ mode: "sea", next: "" }}
