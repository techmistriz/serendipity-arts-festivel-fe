...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — Serendipity Arts Festival 2026" },
      {
        name: "description",
        content:
          "Everything you need to know about attending Serendipity Arts Festival 2026 — Art Pass, bookings, venues, accessibility and volunteering.",
      },
    ],
  }),
  component: FAQ,
