...
export default function RegisterPage() {
    ...
    // Update URL when mode changes (optional)
                                ...
                                <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2">
                                    {GENDERS.map((g) => (
                                        <label key={g} className="flex items-center gap-2 text-sm">
                                            <input type="radio" name="gender" value={g} className="accent-accent" />
                                            {g}
                                        </label>
                                    ))}
                                </div>
        ...
        ${age === a
                                ...
                                <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2">
                                    {HEARD.map((h) => (
                                        <label key={h} className="flex items-center gap-2 text-sm">
                                            <input type="radio" name="heard" value={h} className="accent-accent" />
                                            {h}
                                        </label>
                                    ))}
                                </div>
                            ...
                            <Field label="WhatsApp Number">
                                <div className="grid grid-cols-[110px_1fr] gap-3">
                                    ...
                                    <input inputMode="numeric" maxLength={10} placeholder="10 digit number" className="input" />
                                </div>
                            </Field>

                            <Field label="OTP">
                                <div className="grid grid-cols-[1fr_auto] gap-3">
                                    <input inputMode="numeric" maxLength={6} className="input" />
                        ...
                        <>
                            ...
                            <Field label="WhatsApp Number*">
                                <div className="grid grid-cols-[110px_1fr] gap-3">
                                    ...
                                    <input required inputMode="numeric" maxLength={12} placeholder="WhatsApp number" className="input" />
                                </div>
                            </Field>

                            <Field label="OTP*">
                                <div className="grid grid-cols-[1fr_auto] gap-3">
                                    <input required inputMode="numeric" maxLength={6} className="input" />
                                    <button type="button" className="label border border-foreground rounded-full px-5 hover:bg-foreground hover:text-background transition-colors">
                                        Get OTP
                                    </button>
                                </div>
                        ...
                        <>
                            <Field label="Contact Number*">
                                <div className="grid grid-cols-[140px_1fr] gap-3">
                                    ...
                                    <input required inputMode="numeric" maxLength={12} placeholder="Phone number" className="input" />
                                </div>
                            </Field>
                            ...
                            <YesNo label="Travel Assistance Required*" name="travel" />
                            <YesNo label="Lodging/Boarding Assistance Required*" name="lodging" />
                            <YesNo label="Accommodation Assistance Required*" name="accom" />
                            <YesNo label="Will you be accompanied by anyone?*" name="accompanied" />
...
// Constants and helper components (unchanged)
            ...
            <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2">
                {["Yes", "No"].map((v) => (
                    <label key={v} className="flex items-center gap-2 text-sm">
                        <input type="radio" name={name} value={v} className="accent-accent" />
                        {v}
                    </label>
                ))}
            </div>
