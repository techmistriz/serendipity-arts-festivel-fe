...
import { FESTIVAL_LOGO, FOUNDATION_LOGO, PARTNERS } from "@/src/lib/partners";
...
export const metadata = {
  ...
  openGraph: {
    title: "Partners — Serendipity Arts Festival 2026",
    description: "Supported by the Government of Goa and partner institutions across the state.",
    type: "website",
  },
  twitter: {
    ...
    <div className="container-editorial pt-10 md:pt-20 pb-32 relative">
     ...
     <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <div className="border border-foreground p-6 grid place-items-center min-h-[180px]">
          <Image src={FESTIVAL_LOGO} alt="Serendipity Arts Festival" loading="lazy" className="max-h-28 w-auto object-contain" />
        </div>
        <div className="border border-foreground p-6 grid place-items-center min-h-[180px]">
          <Image src={FOUNDATION_LOGO} alt="Serendipity Arts — Munjal Initiative for Creativity" loading="lazy" className="max-h-20 w-auto object-contain" />
        </div>
      </div>
    </div>
  );
