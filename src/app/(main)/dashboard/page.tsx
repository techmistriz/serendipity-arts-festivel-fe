...
export default function DashboardPage() {
  ...
  const bookings = [
    ...
    {
      id: "3",
      title: "Artist Talk: Contemporary Art",
      venue: "Gallery Hall",
      dates: [16, 17],
      time: "3:00 PM",
      qty: 1,
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-12 border border-foreground p-5 md:p-8">
              ...
              <p className="mt-3 headline text-sm md:text-base text-muted-foreground max-w-prose">
                ...
                registration so you can book in seconds. Delete it and you’ll start from scratch in
                2027 — your past bookings and preferences will be permanently removed after the
                festival closes on 20 December.
              </p>
              <button
            ...
            <div className="relative w-full max-w-lg bg-background border border-foreground p-6 md:p-8">
              ...
              {deleteStep === "comms" && (
                <>
                  ...
                  <p className="mt-4 headline text-sm md:text-base text-muted-foreground">
                    Would you still like to receive communication from Serendipity Arts — programme
                    announcements, grants and open calls?
                  </p>
                  <div className="mt-8 flex flex-wrap gap-3">
                    <button
                      onClick={() => {
              ...
              {deleteStep === "done" && (
                <>
                  <h3 className="display uppercase text-2xl md:text-3xl leading-[1]">Noted.</h3>
                  <p className="mt-4 headline text-sm md:text-base text-muted-foreground">
