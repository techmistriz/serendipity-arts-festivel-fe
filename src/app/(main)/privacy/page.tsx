...
function Section({ n, title, children }: { n: string; title: string; children: React.ReactNode }) {
  return (
    <section className="rule-t pt-8 md:pt-10">
      ...
      <h2 className="mt-2 display uppercase text-2xl md:text-4xl leading-[0.95] tracking-[-0.02em]">
        {title}
      </h2>
  ...
  return (
    <div className="container-editorial pt-10 md:pt-20 pb-32">
      ...
      <p className="mt-6 max-w-2xl text-muted-foreground headline">
        Privacy Notice &amp; Digital Personal Data Protection (DPDP) Statement. This page maintained
        by Serendipity Arts.
      </p>
      ...
      <div className="mt-12 md:mt-16 space-y-12 md:space-y-16">
        <Section n="1" title="Who we are">
          <p>
            Serendipity Arts (“we”, “us”, “our”) operates the Serendipity Arts Festival and related
            programmes. We are the Data Fiduciary for the personal data collected through this
            website and Festival operations, and we are committed to protecting your privacy in
        ...
        <Section n="2" title="What personal data we collect">
          <p>
            ...
            country, age group, gender (where you choose to share it), your interests, and, for paid
            bookings, payment information processed by our payment partners.
          </p>
          <p>
        ...
        <Section n="4" title="Consent">
          <p>
            ...
            <span className="text-foreground">info@serendipityarts.org</span>. Withdrawing consent
            will not affect the lawfulness of processing done before your withdrawal.
          </p>
        </Section>
        ...
        <Section n="6" title="Retention">
          <p>
            ...
            for example, booking records are retained for the duration of the Festival cycle and for
            accounting and audit obligations thereafter. When no longer required, data is securely
        ...
        <Section n="7" title="Your rights">
          ...
          <p>
            ...
            <span className="text-foreground">info@serendipityarts.org</span>. We will respond
            within the timelines set out by law.
          </p>
        </Section>

        <Section n="8" title="Security">
          <p>
            We use industry-standard technical and organisational safeguards — encryption in
            transit, access controls, and staff training — to protect your personal data. No system
            is entirely secure, but we take every reasonable step to keep your information safe.
          </p>
        </Section>
        ...
        <Section n="9" title="Grievance officer">
          ...
          <p className="text-foreground">
            Grievance Officer, Serendipity Arts
            <br />
        ...
        <Section n="10" title="Updates to this notice">
          <p>
            We may update this Privacy Notice from time to time. The most current version will
            always be available on this page, with the date of the last update noted below.
          </p>
