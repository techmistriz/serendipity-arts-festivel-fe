...
export function BookingSuccess({ title = "Booking successful.", onClose }: Props) {
  return (
      ...
      <div className="container-editorial pt-6 md:pt-10 pb-16 max-w-4xl">
        ...
        <div className="mt-10 md:mt-16">
          ...
          <p className="mt-6 max-w-2xl text-muted-foreground headline text-base">
            Your programmes will be added to your Art Pass, available to download closer to the
            festival on our app. Just show it at any venue in front of our zappers.
          </p>
        </div>
...
function LGMRow({ word, children }: { word: string; children: React.ReactNode }) {
  return (
    <div className="grid grid-cols-12 items-center gap-3 md:gap-6 rule-t pt-4 md:pt-5">
      <p className="col-span-4 display uppercase text-foreground text-[9vw] md:text-[4vw] leading-[0.85] tracking-[-0.03em]">
        {word}.
      </p>
